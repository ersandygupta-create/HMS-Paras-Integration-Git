report 50024 "Voucher Post-Print_New"
{
    ApplicationArea = All;
    DefaultLayout = RDLC;
    RDLCLayout = './src/reports/Rpt50024.VoucherRegister.rdlc';
    Caption = 'Voucher Register-Print';
    ...
    dataset
    {
        dataitem("G/L Register"; "G/L Register")
        {
            ...
            dataitem("G/L Entry"; "G/L Entry")
            {
                ...
                column(ChequeDetail; 'Cheque No./RTGS: ' + ChequeNo + ' ' + "EDC UTR No." + '  Dated: ' + Format(ChequeDate))
                {
                }
                ...
                dataitem("Integer"; "Integer")
                {
                    ...
                    begin
                        ...
                        GLEntry.SETRANGE("Entry No.", "G/L Register"."From Entry No.", "G/L Register"."To Entry No.");//ak
                        GLEntry.FindLast;
                ...
                begin
                    ...
                    if GLEntry.FindFirst then begin
                        repeat
                            LineNarrGL := GLEntry."EDC Narration";
