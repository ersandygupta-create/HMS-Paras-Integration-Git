codeunit 50025 "3E Match Bank Rec. Lines"
{
...
#pragma warning restore AA0470
    ...
    begin
        ...
        FeatureTelemetry.LogUptake('0000JLB', BankAccReconciliation.E3GetBankReconciliationTelemetryFeatureName(), Enum::"Feature Uptake Status"::Used);
        Overwrite := true;
        ...
        BankAccReconciliationLine.SetFilter("EDC UTR No.", '<>%1', '');
        ...
        // Lines to match
        BankAccReconciliationLine.Reset();
        BankAccReconciliationLine.E3FilterBankRecLinesByDate(BankAccReconciliation, Overwrite);
        // Candidate Bank Account Ledger Entries
        BankAccountLedgerEntry.E3SetBankReconciliationCandidatesFilter(BankAccReconciliation);
        ...
        FeatureTelemetry.LogUsage('0000JLC', BankAccReconciliation.E3GetBankReconciliationTelemetryFeatureName(), AutomatchEventNameTelemetryTxt);
    end;
    ...
    begin
        ...
        if not BankAccountLedgerEntry.FindSet() then
            exit;
        repeat
            TempBankAccLedgerEntryMatchingBuffer.E3InsertFromBankAccLedgerEntry(BankAccountLedgerEntry);
        until BankAccountLedgerEntry.Next() = 0;
    ...
    var
        ...
        BankAccEntrySetReconNo: Codeunit "E3 Bank Acc. Ent Set";
