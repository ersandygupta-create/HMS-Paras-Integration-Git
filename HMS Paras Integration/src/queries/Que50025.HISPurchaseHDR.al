query 50025 "HIS Purchase Header"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'edhate';
    APIVersion = 'v2.0';
    Caption = 'Pending GRN List';
    EntityName = 'pendingGRNHDRList';
    EntitySetName = 'pendingGRNHDRLists';
    QueryType = API;
    ...
    elements
    {
        ...
        {
            //DataItemTableFilter = "Create PO" = const(false);
