page 50117 "EDC HIS Item Card Pending"
{

    Caption = 'HIS Item Card Pending';
    PageType = Card;
    SourceTable = "EDC HIS Master Staging";
    Editable = false;
    ...
    actions
    {
        area(Processing)
        {
            action("First Level Approval")
            {
                ApplicationArea = basic, suite;
                ToolTip = 'First Level Approval';
                Promoted = true;
                ...
                trigger OnAction()
                var
                    HISCodeUnit: Codeunit "EDC HIS Integration Mgmt.";
                begin
                    if Rec."Party Type" = Rec."Party Type"::Item then begin
                        HISCodeUnit.ItemSendForApproval(rec."Entry No.");
                    end;
                end;
            }
            ...
            action("Rejected")
            {
                ...
                begin
                    ...
                    if Rec."Party Type" = Rec."Party Type"::Item then begin
                        HISIntegration.ItemRejectApproval1(Rec."Entry No.");
                    end;
                end;
            }
        }
