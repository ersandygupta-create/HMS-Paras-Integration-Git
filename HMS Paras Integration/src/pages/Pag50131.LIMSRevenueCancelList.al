page 50131 "EDC LIMS Revenue Cancel List"
{
    ...
    PageType = List;
    Editable = false;
    CardPageId = "EDC LIMS Revenue Cancel Header";
    InsertAllowed = false;
    ...
    actions
    {
        area(Processing)
        {
            action(DeleteSelected)
            {
                ...
                trigger OnAction()
                var
                    RevDelHeader: Record "EDC LIMS Revenue Header";
                begin
    ...
    var
        RevHeader: Record "EDC LIMS Revenue Header";
}
