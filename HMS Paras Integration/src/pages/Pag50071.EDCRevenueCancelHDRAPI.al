page 50071 "EDC Revenue Cancel HDR API"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'edhate';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'edcRevenueCancelHDRAPI';
    DelayedInsert = true;
    EntityName = 'revenuecancelheader';
    EntitySetName = 'revenuecancelheaders';
    PageType = API;
    SourceTable = "EDC HIS Revenue Header";
    ...
    layout
    {
        area(content)
        {
            ...
            part(RevenuecancelLine; "EDC Revenue Cancel Line API")
            {
                Caption = 'Lines';
    ...
    var
        RevenueHeader: Record "EDC HIS Revenue Header";
    begin
