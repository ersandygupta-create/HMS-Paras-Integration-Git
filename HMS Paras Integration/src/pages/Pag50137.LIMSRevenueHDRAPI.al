page 50137 "LIMS Revenue HDR API"
{
    APIGroup = 'apiHIS';
    APIPublisher = 'edhate';
    APIVersion = 'v2.0';
    ApplicationArea = All;
    Caption = 'limsRevenueHDRAPI';
    DelayedInsert = true;
    EntityName = 'limsrevenueheader';
    EntitySetName = 'limsrevenueheaders';
    PageType = API;
    ...
    layout
    {
        area(content)
        {
            ...
            part(RevenueLine; "LIMS Revenue Line API")
            {
                Caption = 'Lines';
                EntityName = 'limsrevenueline';
                EntitySetName = 'limsrevenuelines';
