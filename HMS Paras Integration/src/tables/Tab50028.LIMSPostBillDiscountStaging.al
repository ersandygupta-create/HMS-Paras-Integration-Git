table 50028 "LIMS Post Bill Discount"
{
    Caption = 'Post Bill Discount Staging';
    ...
    fields
    {
        ...
        field(37; "HIS Type"; Enum "EDC HIS Type")
        {
            Caption = 'HIS Type';
            DataClassification = CustomerContent;
        }
        ...
        field(110; "Credit Type"; Option)
        {
            Caption = 'Credit Type';
            OptionMembers = Payer,Payee;
            DataClassification = CustomerContent;
        }
        field(111; "SettlementType"; Option)
        {
